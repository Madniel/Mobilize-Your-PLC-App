...
public class FillTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(FillTime.this, "Device is not selected.", Toast.LENGTH_SHORT).show();
        }
    }

    private void LoadData() {
        api.fill(new standardRequest(MainActivity2.selectedDevice.getId())).enqueue(new Callback<ArrayList<chartValue>>() {
            @Override
